...
@push('manage-bus-reservation-table-scripts')
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function () {
        ...
        window.livewire.on('openBusReservationModal', () => {
            $('#BusReservationModal').modal('show')
        });
        
        window.livewire.on('closeBusReservationModal', () => {
            $('#BusReservationModal').modal('hide')
        });
        ...
        window.livewire.on('openSwalDelete', (BusReservationID) => {
            swal("Are you sure you want to delete this Data?", {
                dangerMode: true,
                buttons: true,
            }).then(okay => {
                if (okay) {
                    window.Livewire.emit('DeleteData', BusReservationID)
                }else{
