...
@push('manage-equipment-reservation-table-scripts')
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function () {
        ...
        window.livewire.on('openEquipmentReservationModal', () => {
            $('#EquipmentReservationModal').modal('show')
        });
        
        window.livewire.on('closeEquipmentReservationModal', () => {
            $('#EquipmentReservationModal').modal('hide')
        });
        ...
        window.livewire.on('openSwalDelete', (EquipmentReservationID) => {
            swal("Are you sure you want to delete this Data?", {
                dangerMode: true,
                buttons: true,
            }).then(okay => {
                if (okay) {
                    window.Livewire.emit('DeleteData', EquipmentReservationID)
                }else{
