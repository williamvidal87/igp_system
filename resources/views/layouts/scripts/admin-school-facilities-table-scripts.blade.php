...
@push('school-facilities-table-scripts')
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function () {
        ...
        window.livewire.on('openSchoolFacilitiesModal', () => {
            $('#SchoolFacilitiesModal').modal('show')
        });
        
        window.livewire.on('closeSchoolFacilitiesModal', () => {
            $('#SchoolFacilitiesModal').modal('hide')
        });
        
        
        
        window.livewire.on('openSwalDelete', (SchoolFacilitiesID) => {
            swal("Are you sure you want to delete this Data?", {
                dangerMode: true,
                buttons: true,
            }).then(okay => {
                if (okay) {
                    window.Livewire.emit('DeleteData', SchoolFacilitiesID)
                }else{
